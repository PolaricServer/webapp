...
<div id="toolbar">
   ...
   <div id="tools" style="text-align:center; padding-top:4px">
       ...
       <img id="toolZoomOut" onclick="myKaMap.olMap.zoomOut()" title="zoom Out" alt="zoom Out" src="KaMap/images/a_pixel.gif">
       <img id="toolZoomIn"  onclick="myKaMap.olMap.zoomIn()"  title="zoom in"  alt="zoom in"  src="KaMap/images/a_pixel.gif" >
