...
cd ..
cd Aprs
ccompile --js iscroll.js --js popup.js --js WXreport.js --js statkartWPS.js --js statkartName.js --js auth.js --js api.js --js contextmenu.js --js messages.js --js menu.js --js layerSwitcher.js --js jscoord.js --js filterProfile.js --js startUp.js > compiled.js
cd ..
cd MobileApp
